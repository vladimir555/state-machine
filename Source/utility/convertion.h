...
public:
     ...
     */
    static string   
    numberToString(int64_t number, int base = 10, size_t count_symbols = 0) 
    throw(Exception);
    /**
     ...
     */
    static int64_t  
    stringToNumber(const string &number, int base = 10)                     
    throw(Exception);
    /**
     ...
     */
    static string   
    byteVectorToString(const vector<byte_t> &v);
    /**
     ...
     */
    static string   
    charVectorToString(const vector<byte_t> &v);
    /**
     ...
     */
    static time_t   
    stringToDateTime(const string &date_time_string)                        
    throw(Exception);
    /**
     *  конвертировать строку в формат времени
     ...
     */
    static string   
    dateTimeToString(const time_t &date_time);
    /**
     ...
     */
    static text_t   
    stringToFixedWideText(string &str_source, const size_t max_string_length);
    /**
     ...
     */
    static text_t   
    textToFixedWideText(const text_t &text_source, const size_t max_string_length);
};
