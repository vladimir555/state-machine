...
private:
    ...
    static const int   SERVICE_STATE_MACHINE_LIMIT_STEP_COUNT      = 5;
    static const int   SERVICE_SOCKET_SERVER_REQUEST_DEQUEUE_SIZE  = 5;
     ...
     *
     */
    utility::StateMachine<Service, State>   service_state_machine;
    /**
     *
     */
    ...
    RequestHandler_                         service_request_handler;
    /**
     *
     */
    SocketServer                            service_socket_server;
    /**
     *
     */
    void                                    handleOnUnknownState(State &state);
    /**
     *
     */
    void                                    handleOnExit        (State &state);
    /**
     *
     */
    void                                    handleOnWaitRequest (State &state);
